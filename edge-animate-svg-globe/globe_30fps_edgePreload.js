...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "globe_30fps_edge.js"},
      { load: "globe_30fps_edgeActions.js"}];
...
var plSTF="none",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="600px",plHeight="400px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['269', '191','62px','18px','auto', 'auto'],
