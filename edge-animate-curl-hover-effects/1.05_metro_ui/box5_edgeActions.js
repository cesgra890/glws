...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         1. From Library Panel drag the "box" symbol on the Stage. Increase the number in name (ie. "box8")
         
         2. Edit array "elements" below. Remove "//" in the commented lines
         
         3. In Library Panel duplicate the symbol "txt_7" and increase the number in name (so it becomes "txt_8").
         You can edit the content of the new symbol by double clicking on the symbol (in Library panel).
         
         TO REMOVE ITEMS: 
         1. Delete symbol from the Stage (ie. "box7")
         2. Remove or comment the array line that contains "box7"
         ...
         */
         ...
         var elements = [
             ...
             ['box5','txt_5','','http://www.example.com?link5'],
             ['box6','txt_6','','http://www.example.com?link6'],
             ['box7','txt_7','','http://www.example.com?link7'],
         //    ['box8','txt_8','','http://www.example.com?link8'],
         ];
         ...
         /* set for some "box..." instances different width/height */
         sym.$("box1").css({"width":"310px"});
         sym.$("box7").css({"width":"310px"});
         sym.$("box4").css({"width":"310px","height":"310px"});
         /* make "curl" element of "box4" different color */
         sym.getSymbol("box4").getSymbol("curl_ani").$("curl_element").css({"background-color":"#111111"});
