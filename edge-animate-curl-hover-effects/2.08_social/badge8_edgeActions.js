...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         TO REMOVE ITEMS: 
         1. Delete symbol from the Stage (ie. "badge5")
         2. Remove or comment the array line that contains "badge5"
         ...
         */
         ...
         var elements = [
             ...
             ['badge5','txt_5','images/badge5.svg','http://www.example.com?link5'],
         ];
         
         clr = "#ffffff"; /* text color */
         clr_over = "#f1f1f1"; /* text color on hover */
         ...
         for (var i = 0; i < elements.length; i++) {
         	...
         	bdg.$("badge").css({"background-image":"url("+elements[i][2]+")"});
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${_hotspot}", "mouseover", function(sym, e) {
         ...
         //this.$("txt-container").animate({marginTop: "-8px"}, 250, "easeOutCubic" );
      ...
      Symbol.bindElementAction(compId, symbolName, "${_hotspot}", "mouseout", function(sym, e) {
         ...
         //this.$("txt-container").animate({marginTop: "0px"}, 250, "easeOutCubic" );
