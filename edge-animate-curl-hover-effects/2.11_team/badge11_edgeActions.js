...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         IF YOU CHANGE STAGE BACKGROUND COLOR, don't forget to change pseudo mask color in SVG file (badge_pseudo_mask.svg):
         .pseudo_mask {fill: #24b296;}
         
         */
         
         //http://randomuser.me/photoshop.html
         var elements = [
             ['badge1','txt_1','images/m2.jpg','http://www.example.com?link1'],
             ['badge2','txt_2','images/fm.jpg','http://www.example.com?link2'],
             ['badge3','txt_3','images/m1.jpg','http://www.example.com?link3'],
         //  ['badge4','txt_4','images/u73.jpg','http://www.example.com?link4'],
         ];
         
         clr = "#d3f0ea"; /* text color */
   ...
   (function(symbolName) {   
         Symbol.bindElementAction(compId, symbolName, "${_hotspot}", "mouseover", function(sym, e) {
            sym.getSymbol("flip_top").play("start");
         ...
         Symbol.bindElementAction(compId, symbolName, "${_hotspot}", "mouseout", function(sym, e) {
            //sym.getSymbol("flip_top").playReverse();
            sym.getSymbol("flip_top").stop(0);
   ...
   //Edge symbol end:'flip_top'

   //=========================================================
   
   //Edge symbol: 'flip_bottom'
   (function(symbolName) {   
   
   })("flip_bottom");
   //Edge symbol end:'flip_bottom'
