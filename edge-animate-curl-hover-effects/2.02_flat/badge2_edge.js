...
var fonts = {};    fonts['droid-sans, sans-serif']='<script src=\"http://use.edgefonts.net/droid-sans:n4,n7:all.js\"></script>';
            ...
            dom: [
                {
                    ...
                    id: 'TextCopy',
                    text: '9',
                    rect: ['69px', '44px', '124px', '90px', 'auto', 'auto'],
                    font: ['droid-sans, sans-serif', 90, 'rgba(51,51,51,1.00)', '400', 'none', '']
                },
                {
                    type: 'text',
                    id: 'TextCopy3',
                    ...
                    font: ['droid-sans, sans-serif', 40, 'rgba(51,51,51,1.00)', 'normal', 'none', '']
                },
                {
                    type: 'text',
                    id: 'TextCopy4',
                    text: 'per<br>month',
                    rect: ['123px', '94px', 'auto', 'auto', 'auto', 'auto'],
                    font: ['droid-sans, sans-serif', 16, 'rgba(51,51,51,1.00)', 'normal', 'none', '']
                }
            ],
            symbolInstances: [
            ]
            ...
            dom: [
                {
                    ...
                    id: 'TextCopy',
                    text: '1',
                    rect: ['44px', '44px', '124px', '90px', 'auto', 'auto'],
                    font: ['droid-sans, sans-serif', 90, 'rgba(51,51,51,1.00)', '400', 'none', '']
                },
                {
                    type: 'text',
                    id: 'Text',
                    text: '5',
                    rect: ['82px', '44px', '124px', '90px', 'auto', 'auto'],
                    font: ['droid-sans, sans-serif', 90, 'rgba(51,51,51,1.00)', '400', 'none', '']
                },
                {
                    type: 'text',
                    id: 'TextCopy3',
                    text: '$',
                    rect: ['25px', '55px', 'auto', 'auto', 'auto', 'auto'],
                    font: ['droid-sans, sans-serif', 40, 'rgba(51,51,51,1.00)', 'normal', 'none', '']
                },
                {
                    type: 'text',
                    id: 'TextCopy2',
                    text: 'per<br>month',
                    rect: ['135px', '94px', 'auto', 'auto', 'auto', 'auto'],
                    font: ['droid-sans, sans-serif', 16, 'rgba(51,51,51,1.00)', 'normal', 'none', '']
                }
            ],
            symbolInstances: [
