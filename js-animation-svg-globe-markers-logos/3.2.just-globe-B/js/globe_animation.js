...
$(document).ready(function(){
    ...
    var globe_intro_duration = 750;
    /*  Globe continents' animation duration (ms)  */
    var globe_ani_duration = 2000;
    ...
    function globe_intro_animation() {
        ...
        $globe_fr.velocity({translateX: [ start_pos_fr + rotation_length, start_pos_fr ]}, {duration: globe_ani_duration, delay: globe_intro_duration});
        $globe_bk.velocity({translateX: [ start_pos_bk - rotation_length, start_pos_bk ]}, {duration: globe_ani_duration, delay: globe_intro_duration});
