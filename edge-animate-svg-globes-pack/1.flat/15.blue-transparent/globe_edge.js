...
"stage": {
    ...
    states: {
        "Base State": {
            "${_Stage}": [
                ["color", "background-color", 'rgba(0,89,199,1.00)'],
                ["style", "overflow", 'hidden'],
                ["style", "height", '400px'],
                ["gradient", "background-image", [270,[['rgba(0,89,199,1.00)',0],['rgba(0,56,126,1.00)',99]]]],
                ["style", "width", '800px']
            ],
            "${_globe}": [
                ["style", "left", '300px'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid877", tween: [ "style", "${_inner-shadow}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
