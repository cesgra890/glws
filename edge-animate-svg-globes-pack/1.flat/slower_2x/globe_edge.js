    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid860", tween: [ "style", "${_flatmap-front}", "left", '0px', { fromValue: '-473px'}], position: 0, duration: 16000 },
                { id: "eid875", tween: [ "style", "${_inner-shadow}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
                { id: "eid851", tween: [ "style", "${_flatmap-back}", "left", '-473px', { fromValue: '0px'}], position: 0, duration: 16000 }            ]
        }
    }
}
};
