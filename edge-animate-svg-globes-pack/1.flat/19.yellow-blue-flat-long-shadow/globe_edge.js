...
"stage": {
    ...
    states: {
        "Base State": {
            "${_Stage}": [
                ["color", "background-color", 'rgba(246,214,58,1.00)'],
                ["style", "width", '800px'],
                ["style", "height", '400px'],
...
"globe": {
            ...
            dom: [
                {
                    ...
                    id: 'long-shadow',
                    opacity: 1,
                    rect: ['-300px', '-300px', '800px', '800px', 'auto', 'auto'],
                    fill: ['rgba(0,0,0,0)', 'images/long-shadow.svg', '0px', '0px']
                },
                {
                    type: 'image',
                    display: 'block',
                ...
                },
                {
                    id: 'stroke',
                    type: 'image',
                    rect: ['-25px', '-25px', '250px', '250px', 'auto', 'auto'],
                    fill: ['rgba(0,0,0,0)', 'images/stroke.svg', '0px', '0px']
                }
            ],
            symbolInstances: [
            {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid311", tween: [ "style", "${_outer-shadow}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid861", tween: [ "style", "${_reflections-2nd}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
                { id: "eid312", tween: [ "style", "${_reflections}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid875", tween: [ "style", "${_inner-shadow}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 }            ]
        }
    }
}
};
