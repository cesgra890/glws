            ...
            dom: [
                {
                    ...
                    fill: ['rgba(0,0,0,0)', 'images/worldmap-flat.svgz', '0px', '0px']
                }
            ],
            symbolInstances: [
            ]
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid860", tween: [ "style", "${_flatmap-front}", "left", '0px', { fromValue: '-430px'}], position: 0, duration: 8000 },
                { id: "eid874", tween: [ "style", "${_inner-shadow}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
                { id: "eid851", tween: [ "style", "${_flatmap-back}", "left", '-430px', { fromValue: '0px'}], position: 0, duration: 8000 }            ]
        }
    }
}
};
