    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid208", tween: [ "style", "${_stroke}", "opacity", '0.5', { fromValue: '0.5'}], position: 100, duration: 0, easing: "easeOutQuad" }            ]
        }
    }
},
"icon": {
...
"tween_container": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid215", tween: [ "style", "${_Ellipse}", "top", '0px', { fromValue: '-90px'}], position: 100, duration: 300, easing: "easeOutQuad" },
                { id: "eid196", tween: [ "style", "${_initial}", "opacity", '1', { fromValue: '1'}], position: 100, duration: 0, easing: "easeOutQuad" },
                { id: "eid214", tween: [ "style", "${_initial}", "opacity", '0', { fromValue: '1'}], position: 400, duration: 0, easing: "easeOutQuad" },
                { id: "eid204", tween: [ "style", "${_hover}", "top", '0%', { fromValue: '-100%'}], position: 100, duration: 300, easing: "easeOutQuad" },
                { id: "eid199", tween: [ "style", "${_initial}", "top", '0%', { fromValue: '0%'}], position: 100, duration: 0, easing: "easeOutQuad" },
                { id: "eid213", tween: [ "style", "${_initial}", "top", '50%', { fromValue: '0%'}], position: 400, duration: 0, easing: "easeOutQuad" },
                { id: "eid216", tween: [ "style", "${_Ellipse}", "opacity", '0', { fromValue: '0'}], position: 0, duration: 0, easing: "easeOutQuad" },
                { id: "eid217", tween: [ "style", "${_Ellipse}", "opacity", '1', { fromValue: '0'}], position: 100, duration: 0, easing: "easeOutQuad" }            ]
        }
    }
},
"ellipse_ani": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid207", tween: [ "style", "${_Ellipse}", "top", '0px', { fromValue: '-90px'}], position: 100, duration: 250, easing: "easeOutQuad" }            ]
        }
    }
}
};
