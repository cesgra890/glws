...
"tween_container": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                { id: "eid205", tween: [ "style", "${_hover}", "top", '0%', { fromValue: '-100%'}], position: 100, duration: 300, easing: "easeOutQuad" },
                { id: "eid210", tween: [ "style", "${_initial}", "top", '50%', { fromValue: '0%'}], position: 100, duration: 150, easing: "easeOutQuad" },
