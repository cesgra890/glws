    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid6", tween: [ "style", "${_Ellipse}", "opacity", '1', { fromValue: '0.150000'}], position: 250, duration: 150 },
                { id: "eid54", tween: [ "style", "${_Ellipse}", "left", '0px', { fromValue: '0px'}], position: 400, duration: 0 },
                { id: "eid99", tween: [ "style", "${_stroke}", "height", '112px', { fromValue: '132px'}], position: 250, duration: 150, easing: "easeOutQuad" },
                { id: "eid57", tween: [ "style", "${_Ellipse}", "width", '100px', { fromValue: '100px'}], position: 400, duration: 0 },
                { id: "eid97", tween: [ "style", "${_stroke}", "top", '-10px', { fromValue: '-20px'}], position: 250, duration: 150, easing: "easeOutQuad" },
                { id: "eid96", tween: [ "style", "${_stroke}", "left", '-10px', { fromValue: '-20px'}], position: 250, duration: 150, easing: "easeOutQuad" },
                { id: "eid98", tween: [ "style", "${_stroke}", "width", '112px', { fromValue: '132px'}], position: 250, duration: 150, easing: "easeOutQuad" },
