    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid162", tween: [ "style", "${_stroke2}", "opacity", '1', { fromValue: '0'}], position: 250, duration: 150, easing: "easeOutQuad" },
                ...
                { id: "eid141", tween: [ "style", "${_stroke}", "opacity", '0.5', { fromValue: '1'}], position: 250, duration: 150, easing: "easeOutQuad" }            ]
        }
    }
},
"icon": {
