...
stageColor = "#3f5175";
sym.$("Stage").css({"background-color":stageColor});

var elements = [
    {instance:'box1', numbers:[100, 50.2], numberColor:'#9ad4f8', numberText:"", img: 'images/m2.jpg', donutColors:["#79c6f6","#fff"], icon:'', iconColor:'#3081b9', text:'William Porter', textColor:'#fff' },
    {instance:'box2', numbers:[100, 75.7], numberColor:'#73cdbd', numberText:"", img: 'images/fm.jpg', donutColors:["#79c6f6","#61df1b"], icon:'', iconColor:'#0ea800', text:'Heather Jordan', textColor:'#fff' },
    {instance:'box3', numbers:[100, 14.9], numberColor:'#88b2ef', numberText:"", img: 'images/m1.jpg', donutColors:["#79c6f6","#b478da"], icon:'', iconColor:'#5b1ba1', text:'Bobby Pierce', textColor:'#fff' },
...
var chartRotate = -180; /* degrees: -360 to 360. */

var donutStrokeLinecap = "round"; /* butt | round */
var donutStroke = 19;
var fullDonutStroke = donutStroke;
var fullDonutColor = "#263146";

var circlePortion = 100; /* percents: 0 to 100. */

var numberTextSize = 60; /* percents: 0 to 100. */
...
svg += "</svg>";
  ...
  box = sym.getSymbol(elements[i].instance);
         	...
         	img.css({
         			"background-size":"100%",
         			"background-image":"url("+elements[i].img+")"
         			});
