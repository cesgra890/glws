...
var elements = [
    {instance:'box1', numbers:[100, 50], numberColor:'#3081b9', numberText:"%", donutColors:["#3081b9","#49dbe8"], icon:'a', iconColor:'#3081b9', text:'Coffee', textColor:'#222' },
    {instance:'box2', numbers:[100, 75], numberColor:'#0ea800', numberText:"%", donutColors:["#0ea800","#61df1b"], icon:'b', iconColor:'#0ea800', text:'Food', textColor:'#222' },
    {instance:'box3', numbers:[100, 60], numberColor:'#5b1ba1', numberText:"%", donutColors:["#5b1ba1","#b478da"], icon:'c', iconColor:'#5b1ba1', text:'Assistance', textColor:'#222' },
...
var animationEasing = "cubic-bezier(0.68, -0.55, 0.265, 1.55)"; /* linear | ease | cubic-bezier(0.785, 0.135, 0.15, 0.86) */

var ruler = false; /* true | false*/
var rulerSegments = 25;
var rulerThickness = 5;
var rulerColor = "#fff";
var rulerDashThickness = 0.1;
var rulerLineCap = "round"; /* butt | round */
