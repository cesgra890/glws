...
var elements = [
    {instance:'box1', numbers:[100, 50], numberColor:'#fff', numberText:"%", donutColors:["#3081b9","#49dbe8"], icon:'', iconColor:'#3081b9', text:'Coffee', textColor:'#222' },
    {instance:'box2', numbers:[100, 75], numberColor:'#fff', numberText:"%", donutColors:["#0ea800","#61df1b"], icon:'', iconColor:'#0ea800', text:'Food', textColor:'#222' },
    {instance:'box3', numbers:[100, 60], numberColor:'#fff', numberText:"%", donutColors:["#5b1ba1","#b478da"], icon:'', iconColor:'#5b1ba1', text:'Assistance', textColor:'#222' },
...
var donutStroke = 26;
var fullDonutStroke = 26;
var fullDonutColor = stageColor;
