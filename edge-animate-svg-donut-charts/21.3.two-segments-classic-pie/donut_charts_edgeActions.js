...
var elements = [
    {instance:'box1', numbers:[100, 67, 33],    numberColors:['#3081b9', '#49dbe8'], numberTexts:["%","%"],   donutColors:["#3081b9","#3081b9"], donut2ndColors:["#49dbe8","#49dbe8"], text:'Clicks', textColor:'#222'},
    {instance:'box2', numbers:[100, 60, 40],    numberColors:['#0ea800', '#61df1b'], numberTexts:["%","%"], donutColors:["#0ea800","#0ea800"], donut2ndColors:["#61df1b","#61df1b"], text:'Views', textColor:'#222'},
    {instance:'box3', numbers:[200, 60, 140],   numberColors:['#5b1ba1', '#b478da'], numberTexts:["",""],   donutColors:["#5b1ba1","#5b1ba1"], donut2ndColors:["#b478da","#b478da"], text:'Impressions', textColor:'#222'},
...
var legendTitles = ["Desktop","Mobile"];
...
var circlePortion = 100.2; /* percents: 0 to 100. */

var numberTextSize = 100; /* percents: 0 to 100. */
var numberTextOpacity = 1; /* 0 to 1. */
var makeBiggerValueBold = false; /* Highlight bigger value with bold text */
