...
var elements = [
    {instance:'box1', numbers:[100, 52, 38], numberColors:['#3081b9', '#49dbe8'], numberTexts:["%", "%"], donutColors:["#3081b9","#3081b9"], donut2ndColors:["#49dbe8","#49dbe8"], text:'2 Points', textColor:'#222' },
    {instance:'box2', numbers:[100, 30, 33], numberColors:['#0ea800', '#61df1b'], numberTexts:["%", "%"], donutColors:["#0ea800","#0ea800"], donut2ndColors:["#61df1b","#61df1b"], text:'3 Points', textColor:'#222' },
    {instance:'box3', numbers:[100, 80, 71], numberColors:['#5b1ba1', '#b478da'], numberTexts:["%", "%"], donutColors:["#5b1ba1","#5b1ba1"], donut2ndColors:["#b478da","#b478da"], text:'Free Throws', textColor:'#222' },
    // {instance:'box4', numbers:[100, 80, 71], numberColors:['#5b1ba1', '#b478da'], numberTexts:["%", "%"], donutColors:["#5b1ba1","#5b1ba1"], donut2ndColors:["#b478da","#b478da"], text:'Free Throws', textColor:'#222' },
];

var legendTitles = ["Macedonia","Serbia"];
...
var donutStroke = 10;
var fullDonutStroke = 10;
var donut2ndScale = 1.17;
var donut2ndStroke = donutStroke/donut2ndScale; /* to make same width as the first donut: 'donutStroke/donut2ndScale' */
...
var rulerDashOffset = 0.4; /* reposition for fine-tuning */
...
//anDir2 = (animationDirection == "CCW" ? "1,1" : "1,0"); /* CW:1,1 | CCW:1,0 */
...
donutPath2 = "M "+boxWidthHalf+", "+boxWidthHalf+" m -"+donutRadius+", 0 a "+donutRadius+","+donutRadius+" 0 "+anDir2+" "+donutRadius*2+",0 a "+donutRadius+","+donutRadius+" 0 "+anDir2+" -"+donutRadius*2+",0 Z";
...
if (nav_user_agent_ie) {
    ...
    ani_donut2nd_transforms_ie = " transform='scale("+chartRotate+" "+boxWidthHalf+" "+boxWidthHalf+")' ";
    ani_donut_transforms_ie = full_donut2nd_transforms_ie;
...
svg += "   <path class='ani_donut'     "+ani_donut_transforms_ie+" d='"+donutPath+"' stroke-linecap='"+donutStrokeLinecap+"' stroke-width='"+donut2ndStroke+"px' fill='none' stroke='url(#lg"+i+")' />";
svg += "   <path class='ani_donut2nd'  "+ani_donut2nd_transforms_ie+" d='"+donutPath2+"' stroke-linecap='"+donutStrokeLinecap+"' stroke-width='"+donutStroke+"px' fill='none' stroke='url(#lg2nd"+i+")' />";
...
if (nav_user_agent_ie != true) {
    ...
    embdStyle +="#chart"+i+" .ani_donut {";
    embdStyle +="    -webkit-transform:rotate("+chartRotate+"deg) scale("+donut2ndScale+"); -webkit-transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="       -moz-transform:rotate("+chartRotate+"deg) scale("+donut2ndScale+");    -moz-transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="         -o-transform:rotate("+chartRotate+"deg) scale("+donut2ndScale+");      -o-transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="            transform:rotate("+chartRotate+"deg) scale("+donut2ndScale+");         transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="}";
