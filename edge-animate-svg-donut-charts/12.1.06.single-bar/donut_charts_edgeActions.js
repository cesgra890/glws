...
var elements = [
    {instance:'box1', numbers:[100, 50], numberColor:'#fff', numberText:"%",  donutColors:["#3081b9","#49dbe8"], icon:'a', iconColor:'#49dbe8', text:'Coffee', textColor:'#fff' },
    {instance:'box2', numbers:[100, 80], numberColor:'#fff', numberText:"%",  donutColors:["#0ea800","#61df1b"], icon:'b', iconColor:'#61df1b', text:'Food', textColor:'#fff' },
    {instance:'box3', numbers:[100, 100], numberColor:'#fff', numberText:"%", donutColors:["#5b1ba1","#b478da"], icon:'c', iconColor:'#b478da', text:'Assistance', textColor:'#fff' },
    // {instance:'box4', numbers:[100, 60], numberColor:'#fff', numberText:"%", donutColors:["#5b1ba1","#b478da"], icon:'c', iconColor:'#5b1ba1', text:'Assistance', textColor:'#fff' },
];
...
var donutStroke = 15;
var fullDonutStroke = 15;
var fullDonutColor = "#3b3c4f";
...
var rulerSegments = 50;
var rulerThickness = 16;
var rulerColor = stageColor;
var rulerDashThickness = 5;
var rulerLineCap = "butt"; /* butt | round */
var rulerDashOffset = 4; /* reposition for fine-tuning */
