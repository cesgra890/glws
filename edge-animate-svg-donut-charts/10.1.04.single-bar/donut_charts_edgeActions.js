...
var elements = [
    {instance:'box1', numbers:[100, 50], numberColor:'#222', numberText:"%", donutColors:["#ff1d00","#ff1d00"], icon:'a', iconColor:'#222', text:'Coffee', textColor:'#222' },
    {instance:'box2', numbers:[100, 75], numberColor:'#222', numberText:"%", donutColors:["#ff1d00","#ff1d00"], icon:'b', iconColor:'#222', text:'Food', textColor:'#222' },
    {instance:'box3', numbers:[100, 60], numberColor:'#222', numberText:"%", donutColors:["#ff1d00","#ff1d00"], icon:'c', iconColor:'#222', text:'Assistance', textColor:'#222' },
...
var chartRotate = 0.5*0; /* degrees: -360 to 360. */

var donutStrokeLinecap = "butt"; /* butt | round */
var donutStroke = 30;
var fullDonutStroke = 24;
var fullDonutColor = "#eef0f0";
...
if (nav_user_agent_ie) {
    ...
    full_donut_ie = " transform='matrix(0.95, 0, 0, 0.95, "+(boxWidthHalf-0.95*boxWidthHalf)+", "+(boxWidthHalf-0.95*boxWidthHalf)+")' ";
}
...
svg += "   <path class='full_donut' "+full_donut_ie+" d='"+donutPath+"' stroke-linecap='"+donutStrokeLinecap+"' stroke-width='"+fullDonutStroke+"px' fill='none' stroke='"+fullDonutColor+"' />";
...
if (nav_user_agent_ie != true) {
    embdStyle +="    -webkit-transform:rotate(0deg) scale(0.95); -webkit-transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="       -moz-transform:rotate(0deg) scale(0.95);    -moz-transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="        -ms-transform:rotate(0deg) scale(0.95);     -ms-transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="         -o-transform:rotate(0deg) scale(0.95);      -o-transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
    embdStyle +="            transform:rotate(0deg) scale(0.95);         transform-origin:"+boxWidthHalf+"px "+boxWidthHalf+"px;";
}
embdStyle +="}";
