...
var elements = [
    {instance:'box1', numbers:[42, 20, 22], numberColors:['#3081b9', '#49dbe8'], numberTexts:["", ""], donutColors:["#3081b9","#3081b9"], donut2ndColors:["#49dbe8","#49dbe8"], text:'Rebounds', textColor:'#222' },
    {instance:'box2', numbers:[77, 43, 34], numberColors:['#0ea800', '#61df1b'], numberTexts:["", ""], donutColors:["#0ea800","#0ea800"], donut2ndColors:["#61df1b","#61df1b"], text:'Points', textColor:'#222' },
    {instance:'box3', numbers:[16,  7,  9], numberColors:['#5b1ba1', '#b478da'], numberTexts:["", ""], donutColors:["#5b1ba1","#5b1ba1"], donut2ndColors:["#b478da","#b478da"], text:'Assists', textColor:'#222' },
    // {instance:'box4', numbers:[16,  7,  9], numberColors:['#5b1ba1', '#b478da'], numberTexts:["", ""], donutColors:["#5b1ba1","#5b1ba1"], donut2ndColors:["#b478da","#b478da"], text:'Assists', textColor:'#222' },
];

var legendTitles = ["Macedonia","Serbia"];

var chartDiameter = 40;
var chartRotate = 90; /* degrees: -360 to 360. */

var donutStrokeLinecap = "butt"; /* butt | round */
var donutStroke = chartDiameter*2;
var donutStrokeBigger = chartDiameter*2;
var fullDonutStroke = chartDiameter*2;
var fullDonutColor = "#fff";
...
var circlePortion = 100.2; /* percents: 100 only */
var embdStyle = "";
var anDir = "1,1";
var anDir2 = "1,0";
...
svg += "   <path class='ani_donut'    d='"+donutPath2+"' stroke-linecap='"+donutStrokeLinecap+"' stroke-width='"+donutStroke1+"px' fill='none' stroke='url(#lg"+i+")' />";
svg += "   <path class='ani_donut2nd' d='"+donutPath+"' stroke-linecap='"+donutStrokeLinecap+"' stroke-width='"+donutStroke2+"px' fill='none' stroke='url(#lg2nd"+i+")' />";
...
svg += "</svg>";
  ...
  box.$("number").css({"color":"#fff"});
  box.$("number_2nd").css({"color":"#fff"});
  box.$("divider").css({"opacity":"0"});
